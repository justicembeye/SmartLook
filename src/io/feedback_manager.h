...
// Énumération pour les différents patterns de feedback
typedef enum {
    FB_PATTERN_NONE,
    FB_PATTERN_SUCCESS,
    FB_PATTERN_ERROR,
...
// Tâche du gestionnaire de feedback, à appeler régulièrement par le scheduler
void feedback_manager_task();

// Fonctions publiques pour demander un pattern de feedback
...
void feedback_stop(); // NOUVELLE fonction pour arrêter explicitement le feedback
