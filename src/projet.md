...
flowchart TD
    subgraph "Ciclo di Intervento del Tecnico"
        ...
        D -- "Sì" --> E["✅ Apre la serratura<br>e registra l'accesso"];
        D -- "No" --> F["❌ Rifiuta l'accesso<br>e registra il fallimento"];
        ...
        J --> C;
        C -- "Comando di uscita..." --> K["✅ Apre la serratura<br>e registra l'uscita"];
...
flowchart TD
    subgraph "Dispositivo Hardware"
        ...
        MCU["🧠 Arduino Nano ESP32<br>(La Nostra Macchina a Stati)"]
